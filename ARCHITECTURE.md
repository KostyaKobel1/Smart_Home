...
├── global.header-nav.partial.html    # Partial: шапка
...
5. **Додатковий функціонал:**
   - Статистика (total, online/offline, розподіл по типам)
   - Event Log (журнал останніх подій)
...
- **Toast-повідомлення** - feedback про успішність операцій
